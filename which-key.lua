	...
	lvim.builtin.which_key = {
		...
		mappings = {
			...
			j = {
				name = "Copilot",
				c = { "<cmd>Co<CR>", "Copilot" },
				--TODO: how the fuck do I remap copilot in whichkey
			},
			t = {
				name = "Trouble",
			...
			r = { --https://github.com/ThePrimeagen/refactoring.nvim
				name = "Refactor",
				e = { ":Refactor extract<CR>", "Extract", mode = { "x" } },
				f = { ":Refactor extract_to_file<CR>", "Extract to file", mode = { "x" } },
				v = { ":Refactor extract_var<CR>", "Extract var", mode = { "x" } },
				i = { ":Refactor inline_var<CR>", "Inline var", mode = { "n", "x" } },
				I = { ":Refactor inline_func<CR>", "Inline func", mode = { "n" } },
				b = { ":Refactor extract_block<CR>", "Extract block", mode = { "n" } },
				bf = { ":Refactor extract_block_to_file<CR>", "Extract block to file", mode = { "n" } },
			},
		},
	}
end
